    ...
    public class ProjectTests
    {
        ...
        public async Task UpdateAsync_ReturnsNull_ShouldFail()
        {
            ...
            _mockProjectRepository
                .Setup(x => x.UpdateProjectAsync(1, It.IsAny<SaveProjectDTO>()))
        ...
        public async Task UpdateAsync_NonExistingEmployees_ShouldFail()
        {
            ...
            _mockEmployeeRepository
                .Setup(x => x.GetMissingIds(testDto.EmployeeIds))
                .ReturnsAsync(testDto.EmployeeIds);
        ...
        {
            var invalidPageQuery = new QueryDTO { Page = -1, ItemsPerPage = 5 };
        ...
        {
            var invalidItemsPerPageQuery = new QueryDTO { Page = 1, ItemsPerPage = -5 };
